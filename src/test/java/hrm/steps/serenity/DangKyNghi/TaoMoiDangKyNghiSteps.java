...
public class TaoMoiDangKyNghiSteps {
	...
	public void select_nguoi_lien_quan(String sNguoiLienQuan) {
		TMDKNPage.select_nguoi_lien_quan(sNguoiLienQuan);
	}

	@Step
	public String nguoi_lien_quan() {
		return TMDKNPage.nguoi_lien_quan();
	}

	@Step
	public boolean exist_nguoi_lien_quan() {
		return TMDKNPage.exist_nguoi_lien_quan();
	}

	@Step
	public boolean enabled_nguoi_lien_quan() {
		return TMDKNPage.enabled_nguoi_lien_quan();
	}

	@Step
	public boolean focus_nguoi_lien_quan() {
		return TMDKNPage.focus_nguoi_lien_quan();
	}

	// Địa điểm nghỉ phép
	@Step
	public void enter_dia_diem_nghi_phep(String sDiaDiemNghiPhep) {
		TMDKNPage.enter_dia_diem_nghi_phep(sDiaDiemNghiPhep);
	}

	@Step
	public String dia_diem_nghi_phep() {
		return TMDKNPage.dia_diem_nghi_phep();
	}

	@Step
	public boolean exist_dia_diem_nghi_phep() {
		return TMDKNPage.exist_dia_diem_nghi_phep();
	}

	@Step
	public boolean enabled_dia_diem_nghi_phep() {
		return TMDKNPage.enabled_dia_diem_nghi_phep();
	}

	@Step
	public boolean focus_dia_diem_nghi_phep() {
		return TMDKNPage.focus_dia_diem_nghi_phep();
	}

	// Nhân sự được ủy quyền
	@Step
	public void select_nhan_su_duoc_uy_quyen(String sNhanSuDuocUyQuyen) {
		TMDKNPage.select_nhan_su_duoc_uy_quyen(sNhanSuDuocUyQuyen);
	}

	@Step
	public String nhan_su_duoc_uy_quyen() {
		return TMDKNPage.nhan_su_duoc_uy_quyen();
	}

	@Step
	public boolean exist_nhan_su_duoc_uy_quyen() {
		return TMDKNPage.exist_nhan_su_duoc_uy_quyen();
	}

	@Step
	public boolean enabled_nhan_su_duoc_uy_quyen() {
		return TMDKNPage.enabled_nhan_su_duoc_uy_quyen();
	}

	@Step
	public boolean focus_nhan_su_duoc_uy_quyen() {
		return TMDKNPage.focus_nhan_su_duoc_uy_quyen();
	}

	// Nghỉ đi nước ngoài
	@Step
	public void set_nghi_di_nuoc_ngoai(String sNghiDiNuocNgoai) {
		TMDKNPage.set_nghi_di_nuoc_ngoai(sNghiDiNuocNgoai);
	}

	@Step
	public boolean nghi_di_nuoc_ngoai() {
		return TMDKNPage.nghi_di_nuoc_ngoai();
	}

	@Step
	public boolean exist_nghi_di_nuoc_ngoai() {
		return TMDKNPage.exist_nghi_di_nuoc_ngoai();
	}

	@Step
	public boolean enabled_nghi_di_nuoc_ngoai() {
		return TMDKNPage.enabled_nghi_di_nuoc_ngoai();
	}

	@Step
	public boolean focus_nghi_di_nuoc_ngoai() {
		return TMDKNPage.focus_nghi_di_nuoc_ngoai();
	}
